...
const fetchAPIData = async (page, size) => {
  const data = await axios.get(`https://api.instantwebtools.net/v1/passenger?page=${page}&size=${size}`);
  return data.data;
};
  ...
  return data.data.map( (item, i) => {
    if( isArray(item))
    {
      ...
      return {
        ...
        lastName: details.airline.slogan,
        progress: details.airline.id,
        status: 'complicated',
        subRows: details.trips,
        visits: details.trips,
      };
    }
